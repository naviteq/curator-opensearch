...
def copy_aliases():
    return {
        Optional("copy_aliases", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def delete_after():
    return {
        Optional("delete_after", default=True): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def delete_aliases():
    return {
        Optional("delete_aliases", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def skip_flush():
    return {
        Optional("skip_flush", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def disable_action():
    return {
        Optional("disable_action", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def ignore_existing():
    return {
        Optional("ignore_existing", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def ignore_sync_failures():
    return {
        Optional("ignore_sync_failures", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def include_aliases():
    return {
        Optional("include_aliases", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def partial():
    return {
        Optional("partial", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def remote_ssl_no_validate():
    return {
        Optional("remote_ssl_no_validate", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def skip_repo_fs_check():
    return {
        Optional("skip_repo_fs_check", default=False): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def timeout_override(action):
    ...
    return {Optional("timeout_override", default=value): Any(Coerce(int), None)}
...
def wait_for_active_shards(action):
    ...
    if action in ["reindex", "shrink"]:
        value = 1
    return {
        Optional("wait_for_active_shards", default=value): Any(Coerce(int), "all", None)
    }
...
def wait_for_completion(action):
    ...
    if action in ["allocation", "cluster_routing", "replicas"]:
        value = False
    return {
        Optional("wait_for_completion", default=value): Any(
            bool, All(Any(*string_types), Boolean())
        )
    }
...
def wait_interval(action):
    ...
    if action in ["restore", "snapshot", "reindex", "shrink"]:
        value = 9
    return {
        Optional("wait_interval", default=value): Any(
