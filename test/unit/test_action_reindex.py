...
class TestActionReindex(TestCase):
    ...
    def test_init_raise_bad_request_body(self):
        ...
        self.assertRaises(curator.ConfigurationError, curator.Reindex, ilo, "invalid")
    ...
    def test_init_raise_local_migration_no_prefix_or_suffix(self):
        ...
        ilo = curator.IndexList(client)
        self.assertRaises(
            curator.ConfigurationError, curator.Reindex, ilo, testvars.reindex_migration
        )
    ...
    def test_reindex_without_wait(self):
        ...
        client.tasks.get.return_value = testvars.completed_task
        ilo = curator.IndexList(client)
        ro = curator.Reindex(ilo, testvars.reindex_basic, wait_for_completion=False)
        self.assertIsNone(ro.do_action())
    ...
    def test_reindex_timedout(self):
        ...
        ilo = curator.IndexList(client)
        ro = curator.Reindex(ilo, testvars.reindex_basic, max_wait=1, wait_interval=1)
    ...
    def test_remote_with_no_host_key(self):
        ...
        client.indices.get_settings.return_value = {"other_index": {}}
        badval = {
            "source": {"index": "irrelevant", "remote": {"wrong": "invalid"}},
            "dest": {"index": "other_index"},
        }
        self.assertRaises(curator.ConfigurationError, curator.Reindex, ilo, badval)
    ...
    def test_remote_with_bad_host(self):
        ...
        client.indices.get_settings.return_value = {"other_index": {}}
        badval = {
            "source": {"index": "irrelevant", "remote": {"host": "invalid"}},
            "dest": {"index": "other_index"},
        }
        self.assertRaises(curator.ConfigurationError, curator.Reindex, ilo, badval)
