...
class TestActionShrink_data_node(TestCase):
    ...
    def test_non_data_node(self):
        ...
        self.client.nodes.info.return_value = {
            "nodes": {self.node_id: {"roles": ["ingest"]}}
        }
...
class TestActionShrink_qualify_single_node(TestCase):
    ...
    def test_excluded(self):
        self.builder()
        node_filters = {"exclude_nodes": [self.node_name]}
        shrink = curator.Shrink(
            self.ilo, shrink_node=self.node_name, node_filters=node_filters
        )
        self.assertRaises(curator.ConfigurationError, shrink.qualify_single_node)
...
class TestActionShrink_various(TestCase):
    ...
    def test_target_exists(self):
        ...
        self.assertRaises(
            curator.ActionError, shrink._check_target_exists, testvars.named_index
        )
    ...
    def test_doc_count(self):
        ...
        shrink = curator.Shrink(self.ilo)
        self.assertRaises(
            curator.ActionError, shrink._check_doc_count, testvars.named_index
        )
    ...
    def test_check_all_shards(self):
        ...
        self.assertRaises(
            curator.ActionError, shrink._check_all_shards, testvars.named_index
        )
