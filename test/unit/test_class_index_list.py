...
class TestIndexListClientAndInit(TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            testvars.stats_two["indices"]["index-2016.03.03"]["total"]["store"][
                "size_in_bytes"
            ],
...
class TestIndexListAgeFilterName(TestCase):
    ...
    def test_get_name_based_ages_no_match(self):
        ...
        self.assertEqual(
            curator.fix_epoch(
                testvars.settings_two["index-2016.03.03"]["settings"]["index"][
                    "creation_date"
                ]
            ),
...
class TestIndexListFilterByAge(TestCase):
    def test_missing_direction(self):
        ...
        il = curator.IndexList(client)
        self.assertRaises(
            curator.MissingArgument, il.filter_by_age, unit="days", unit_count=1
        )
    ...
    def test_bad_direction(self):
        ...
        il = curator.IndexList(client)
        self.assertRaises(
            ValueError, il.filter_by_age, unit="days", unit_count=1, direction="invalid"
        )
    ...
    def test_creation_date_younger_than_now(self):
        ...
        il = curator.IndexList(client)
        il.filter_by_age(
            source="creation_date", direction="younger", unit="days", unit_count=1
        )
        self.assertEqual([], sorted(il.indices))
...
class TestIndexListFilterBySpace(TestCase):
    ...
    def test_filter_result_by_date_timestring(self):
        ...
        il = curator.IndexList(client)
        il.filter_by_space(
            disk_space=2.1, use_age=True, source="name", timestring="%Y.%m.%d"
        )
    ...
    def test_filter_result_by_date_non_matching_timestring(self):
        ...
        il = curator.IndexList(client)
        il.filter_by_space(
            disk_space=2.1, use_age=True, source="name", timestring="%Y.%m.%d.%H"
        )
        self.assertEqual([], sorted(il.indices))
    ...
    def test_filter_bad_threshold_behavior(self):
        ...
        il = curator.IndexList(client)
        self.assertRaises(
            ValueError, il.filter_by_space, disk_space=1.5, threshold_behavior="invalid"
        )
...
class TestIndexListFilterAllocated(TestCase):
    ...
    def test_invalid_tag(self):
        ...
        client.indices.stats.return_value = testvars.stats_two
        il = curator.IndexList(client)
        il.filter_allocated(key="invalid", value="foo", allocation_type="include")
        self.assertEqual(["index-2016.03.03", "index-2016.03.04"], sorted(il.indices))
...
class TestIterateFiltersIndex(TestCase):
    ...
    def test_no_filtertype(self):
        ...
        self.assertRaises(curator.ConfigurationError, ilo.iterate_filters, config)
    ...
    def test_kibana_filtertype(self):
        ...
        ilo = curator.IndexList(client)
        # Establish the object per requirements, then overwrite
        ilo.indices = [".kibana", ".kibana-5", ".kibana-6", "dummy"]
    ...
    def test_ilm_filtertype_exclude(self):
        ...
        with_ilm["index-2016.03.03"]["settings"]["index"]["lifecycle"] = {
            "name": "mypolicy"
        }
...
class TestIndexListFilterAlias(TestCase):
    ...
    def test_positive(self):
        ...
        self.assertEqual(sorted(list(testvars.settings_two.keys())), sorted(il.indices))
    ...
    def test_negative(self):
        ...
        self.assertEqual(sorted([]), sorted(il.indices))
...
class TestIndexListFilterCount(TestCase):
    ...
    def test_with_age_reversed(self):
        self.builder()
        self.il.filter_by_count(
            count=1, use_age=True, source="name", timestring="%Y.%m.%d", reverse=False
        )
        self.assertEqual(["index-2016.03.04"], self.il.indices)
...
class TestIndexListFilterShards(TestCase):
    ...
    def test_bad_shard_count_raise_1(self):
        self.builder()
        self.assertRaises(
            curator.MissingArgument, self.il.filter_by_shards, number_of_shards=0
        )
    ...
    def test_greater_than_or_equal(self):
        self.builder()
        self.il.filter_by_shards(
            number_of_shards=5, shard_filter_behavior="greater_than_or_equal"
        )
        self.assertEqual(
    ...
    def test_greater_than_or_equal_exclude(self):
        ...
        self.assertEqual(sorted([]), sorted(self.il.indices))
    ...
    def test_less_than_or_equal(self):
        self.builder()
        self.il.filter_by_shards(
            number_of_shards=5, shard_filter_behavior="less_than_or_equal"
        )
        self.assertEqual(
            sorted(["index-2016.03.03", "index-2016.03.04"]), sorted(self.il.indices)
        )
    ...
    def test_less_than_or_equal_exclude(self):
        self.builder()
        self.il.filter_by_shards(
            number_of_shards=5, shard_filter_behavior="less_than_or_equal", exclude=True
        )
        self.assertEqual(sorted([]), sorted(self.il.indices))
    ...
    def test_less_than_exclude(self):
        self.builder()
        self.il.filter_by_shards(
            number_of_shards=5, shard_filter_behavior="less_than", exclude=True
        )
        self.assertEqual(
            sorted(["index-2016.03.03", "index-2016.03.04"]), sorted(self.il.indices)
        )
...
class TestIndexListPeriodFilterName(TestCase):
    ...
    def test_non_integer_range_value(self):
        ...
        il = curator.IndexList(client)
        self.assertRaises(
            curator.ConfigurationError, il.filter_period, range_from="invalid"
        )
...
class TestIndexListFilterBySize(TestCase):
    ...
    def test_filter_by_size_behavior_total_and_threshold_behavior_less_than(self):
        ...
        il = curator.IndexList(client)
        il.filter_by_size(
            size_threshold=1.04, size_behavior="total", threshold_behavior="less_than"
        )
        self.assertEqual(["index-2016.03.03"], il.indices)
