...
class TestCLI_A(TestCase):
    ...
    def test_loginfo_bad_level_raises(self):
        self.assertRaises(ValueError, curator.LogInfo, {"loglevel": "NOTALOGLEVEL"})
    ...
    def test_client_options_certificate(self):
        ...
        self.assertRaises(curator.FailedExecution, curator.test_client_options, a)
...
class TestCLI_B(CLITestCase):
    ...
    def test_read_file_missing_fail(self):
        self.assertRaises(
            curator.FailedExecution, curator.read_file, self.args["no_file_here"]
        )
