...
class TestActionFileUnfreezeFrozen(CuratorTestCase):
    def test_unfreeze_frozen(self):
        ...
        self.write_config(
            self.args["actionfile"], testvars.optionless_proto.format("unfreeze")
        )
    ...
    def test_extra_option(self):
        ...
        self.write_config(
            self.args["actionfile"], testvars.bad_option_proto_test.format("unfreeze")
        )
...
class TestCLIUnfreezeFrozen(CuratorTestCase):
    def test_unfreeze_frozen(self):
        ...
        self.assertEqual(
            0,
            self.run_subprocess(
                args, logname="TestCLIUnfreezeFrozen.test_unfreeze_frozen"
            ),
        )
        cluster_state = self.client.cluster.state(
            metric="metadata",
