...
class TestActionAllocation(TestCase):
    def test_bad_client(self):
        self.assertRaises(
            TypeError, curator.ClusterRouting, "invalid", setting="enable"
        )

    def test_bad_setting(self):
        client = Mock()
        self.assertRaises(ValueError, curator.ClusterRouting, client, setting="invalid")
    ...
    def test_do_dry_run(self):
        ...
        cro = curator.ClusterRouting(
            client, routing_type="allocation", setting="enable", value="all"
        )
