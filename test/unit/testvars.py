...
four_oh_one = opensearchpy.TransportError(401, "simulated error")
four_oh_four = opensearchpy.TransportError(404, "simulated error")
get_alias_fail = opensearchpy.NotFoundError(404, "simulated error")
...
sync_conflict = opensearchpy.ConflictError(
    409,
...
clu_state_one = {"metadata": {"indices": settings_one}}
clu_state_two = {"metadata": {"indices": settings_two}}
cs_two_closed = {"metadata": {"indices": settings_2_closed}}
clu_state_two_no_cd = {"metadata": {"indices": settings_two_no_cd}}
clu_state_four = {"metadata": {"indices": settings_four}}
...
not_rollable_name = {"index": {"aliases": {"foo": {}}}}
not_rollable_multiple = {
    "index-a": {"aliases": {"foo": {}}},
    "index-b": {"aliases": {"foo": {}}},
}
not_rollable_non_numeric = {"index-a": {"aliases": {"foo": {}}}}
is_rollable_2digits = {"index-00001": {"aliases": {"foo": {}}}}
is_rollable_hypenated = {"index-2017.03.07-1": {"aliases": {"foo": {}}}}
