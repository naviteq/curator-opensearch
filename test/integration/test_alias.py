...
class TestActionFileAlias(CuratorTestCase):
    ...
    def test_add_and_remove_datemath(self):
        ...
        alias_parsed = "testalias-{0}".format(
    ...
    def test_remove_with_empty_add(self):
        ...
        self.assertEqual(
            {"my_index": {"aliases": {alias: {}}}}, self.client.indices.get_alias(alias)
        )
    ...
    def test_add_with_empty_list(self):
        ...
        self.assertEqual(
            {"dummy": {"aliases": {alias: {}}}}, self.client.indices.get_alias(alias)
        )
    ...
    def test_remove_index_not_in_alias(self):
        ...
        self.assertRaises(
            elasticsearch.exceptions.NotFoundError, self.client.indices.get_alias, alias
        )
...
class TestCLIAlias(CuratorTestCase):
    def test_add_and_remove_alias(self):
        ...
        self.assertEqual(
            0, self.run_subprocess(args, logname="TestCLIAlias.test_shrink")
        )
        self.assertEqual(
            {"dummy": {"aliases": {alias: {}}}},
            self.client.indices.get_alias(name=alias),
    ...
    def test_warn_if_no_indices(self):
        ...
        self.assertEqual(
            0, self.run_subprocess(args, logname="TestCLIAlias.test_warn_if_no_indices")
        )
        self.assertEqual(
